...
public static void main(String[] args) {
		...
		while(true) {
			...
			con.setDrawColor(Color.WHITE);
			con.drawString(String.format("%d",intHand[0][0]), 200, 215);
			con.drawString(String.format("%d",intHand[1][0]), 400, 215);
			con.drawString(String.format("%d",intHand[2][0]), 600, 215);
			con.drawString(String.format("%d",intHand[3][0]), 800, 215);
			con.drawString(String.format("%d",intHand[4][0]), 1000, 215);
